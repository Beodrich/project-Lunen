...
//[CustomPropertyDrawer(typeof(DictionaryString))]
//public class DictionaryStringStringDrawer : DictionaryDrawer<string, string> { }
[Serializable] public class LevelUpAction : SerializableDictionary<LunaDex.ActionEnum, int> { }